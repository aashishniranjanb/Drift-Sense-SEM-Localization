...
def run_v26b():
    ...
    for thresh in thresholds:
        ...
        for r in results_list:
            ...
            X_pres = pd.DataFrame([{
                'top1_score': r['anchor']['v25_ml_score'], 
                'margin': margin,
                'top1_corr': r['anchor']['corr_score'],
                'top1_ctx': r['anchor']['context_combined'],
                'top1_neigh': r['anchor']['neigh_cons'],
                'top1_grad': r['anchor']['grad_ncc'],
                'mode_strong': r['anchor']['mode_strong']
            }])

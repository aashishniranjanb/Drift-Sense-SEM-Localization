...
report_text = """# V40 Pose Forensics & Robustness Report
...
with open('phase2/V40_POSE_FORENSICS/V40_POSE_REPORT.md', 'w', encoding='utf-8') as f:
    f.write(report_text)
print('Report written to phase2/V40_POSE_FORENSICS/V40_POSE_REPORT.md')

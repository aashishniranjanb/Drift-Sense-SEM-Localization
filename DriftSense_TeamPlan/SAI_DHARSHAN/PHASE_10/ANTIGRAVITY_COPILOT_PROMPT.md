# ANTIGRAVITY / COPILOT — SAI_DHARSHAN — V10.6
...
PHASE: 10
VERSION: V10.6
TASK: High-Recall Candidate Retrieval
...
## OBJECTIVE
Raise candidate retrieval recall without changing the frozen external inference contract.

## DELIVERABLES
- retrieval_audit.py
- retrieval_v106.py
- V10.6_RETRIEVAL_RECALL.md
- V10.6_RETRIEVAL_CURVE.csv
